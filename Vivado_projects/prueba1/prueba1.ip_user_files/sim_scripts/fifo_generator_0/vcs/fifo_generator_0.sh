...
#
# Generated by Vivado on Wed Mar 16 13:15:58 +0100 2022
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"D:/Vivado/2020.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"D:/Vivado/2020.1/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_5 $vlogan_opts +v2k +incdir+"D:/Vivado/2020.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"D:/Vivado/2020.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../prueba1.srcs/sources_1/ip/fifo_generator_0/sim/fifo_generator_0.v" \
  2>&1 | tee -a vlogan.log
