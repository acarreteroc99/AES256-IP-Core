...
HD_PWD='C:/Users/RMartinez/Projects/RiscV/ProyectoAdrin/vivado/prueba1/prueba1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source prueba_bd_wrapper.tcl -notrace
