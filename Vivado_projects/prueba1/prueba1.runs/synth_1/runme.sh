...
HD_PWD='C:/Users/RMartinez/Projects/RiscV/ProyectoAdrin/vivado/prueba1/prueba1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_bd_wrapper.tcl
