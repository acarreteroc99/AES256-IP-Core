...
HD_PWD='C:/Users/RMartinez/Projects/RiscV/ProyectoAdrin/vivado/prueba1/prueba1.runs/prueba_bd_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prueba_bd_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prueba_bd_xbar_0.tcl
