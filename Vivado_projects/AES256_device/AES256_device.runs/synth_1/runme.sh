...
HD_PWD='/home/adrian/Desktop/AES256-HW-Accelerator/Vivado_projects/AES256_device/AES256_device.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES256_device.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES256_device.tcl
