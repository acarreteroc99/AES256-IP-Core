...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: AES256_Encrypt_AXI_0, and set properties
	set AES256_Encrypt_AXI_0 [ create_bd_cell -type ip -vlnv user.org:user:AES256_Encrypt_AXI:1.0 AES256_Encrypt_AXI_0 ]
	...
	# Connect all clock & reset of AES256_Encrypt_AXI_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins AES256_Encrypt_AXI_0/Input_AXI]
	connect_bd_net [get_bd_pins AES256_Encrypt_AXI_0/input_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AES256_Encrypt_AXI_0/input_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins AES256_Encrypt_AXI_0/Ouput_AXI]
	connect_bd_net [get_bd_pins AES256_Encrypt_AXI_0/ouput_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins AES256_Encrypt_AXI_0/ouput_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to AES256_Encrypt_AXI_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/AES256_Encrypt_AXI_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AES256_Encrypt_AXI_0_Input_AXI_* ]]
	puts $fp "set input_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_AES256_Encrypt_AXI_0_Ouput_AXI_* ]]
	puts $fp "set ouput_axi_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:AES256_Encrypt_AXI:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/AES256_Encrypt_AXI_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "AES256_Encrypt_AXI_v1_0_hw_${i}"
