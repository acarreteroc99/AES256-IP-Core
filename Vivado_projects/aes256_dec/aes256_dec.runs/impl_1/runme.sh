...
HD_PWD='/home/adrian/Desktop/AES256-HW-Accelerator/Vivado_projects/aes256_dec/aes256_dec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES256_dec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES256_dec.tcl -notrace
