...
HD_PWD='/home/adrian/Desktop/AES256-HW-Accelerator/Vivado_projects/aes256_dec/aes256_dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES256_dec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES256_dec.tcl
