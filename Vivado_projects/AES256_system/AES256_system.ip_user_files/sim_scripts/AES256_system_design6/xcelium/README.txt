...
#
# Generated by export_simulation on Wed Jan 12 00:35:03 CET 2022
#
################################################################################
...
'-reset_run' switch to the './AES256_system_design6.sh' script.

./AES256_system_design6.sh -reset_run
...
./AES256_system_design6.sh -noclean_files

For more information on the script, please type './AES256_system_design6.sh -help'.
