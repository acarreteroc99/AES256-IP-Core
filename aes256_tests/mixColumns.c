...
void init_state(){
  ...
  */
  ...
  /*
  state[0] = 0xab; state[4] = 0xab; state[8] = 0xd7;    state[12] = 0xfe;
  state[1] = 0x67; state[5] = 0x01; state[9] = 0x30;    state[13] = 0x01;
  state[2] = 0x6b; state[6] = 0xf2; state[10] = 0xf2;   state[14] = 0x6f;
  state[3] = 0x63; state[7] = 0xc5; state[11] = 0x77;   state[15] = 0x7c;
  */

  state[0] = 0xab; state[1] = 0xab; state[2] = 0xd7;    state[3] = 0xfe;
  state[4] = 0x67; state[5] = 0x01; state[6] = 0x30;    state[7] = 0x01;
  state[8] = 0x6b; state[9] = 0xf2; state[10] = 0xf2;   state[11] = 0x6f;
  state[12] = 0x63; state[13] = 0xc5; state[14] = 0x77;   state[15] = 0x7c;
