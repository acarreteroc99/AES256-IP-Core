...
int main()
{
    ...
    unsigned char input[32] = {
                                0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 07, 0x08, 0x09, 
    ...
    */
    ...
    keyExpansion(input, wordlist, Rcon);

    cout << "------------ KEYS FOR AES256 ---------" << endl;
    //cout << typeid(wordlist[0]).name() << endl;
    //printf("%x \n", wordlist[0][3]);

    for (int index = 0; index < 60; index++){
        for(int i = 0; i<4; i++){
           printf("%02x", wordlist[index][i]);
        }
        if(index%4 == 3)
            printf("\n");
    }
